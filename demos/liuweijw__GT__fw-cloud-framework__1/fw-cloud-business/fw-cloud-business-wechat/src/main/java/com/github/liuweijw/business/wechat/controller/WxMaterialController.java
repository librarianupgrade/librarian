...
public class WxMaterialController {
	...
	public R<WxMpMaterialFileBatchGetResult> getFile(HttpServletRequest request, HttpServletResponse response) {
		try {
			WxMpMaterialFileBatchGetResult newsResult = wxService.getMaterialService().materialFileBatchGet("image", 0,
					20);
