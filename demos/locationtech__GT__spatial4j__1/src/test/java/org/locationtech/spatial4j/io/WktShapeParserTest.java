...
public class WktShapeParserTest extends RandomizedTest {
	...
	public void testParseMultiPoint() throws ParseException {
		...
		Shape s4 = ctx.getShapeFactory().multiPoint().pointXY(10, 40).pointXY(40, 30).pointXY(20, 20).pointXY(30, 10)
				.build();
	...
	public void testGeomCollection() throws ParseException {
		...
		Shape s2 = shapeFactory.multiShape(Shape.class).add(shapeFactory.rect(1, 2, 3, 4))
				.add(shapeFactory.pointXY(-1, -2)).build();
